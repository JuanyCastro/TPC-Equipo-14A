            ...
            <div class="card-body p-4 p-md-5 bg-white rounded-bottom-4">
                ...
                <div class="mb-2">
                    ...
                    <div class="input-group rounded-pill input-wrapper px-2 py-1 shadow-sm">
                        ...
                        <button class="btn border-0 text-secondary shadow-none" type="button" id="btnTogglePassword"><i class="fa-solid fa-eye" id="eyeIcon"></i></button>
                    </div>
                </div>
                ...
                <div class="mt-4">
                    <asp:Button ID="btnLogin" runat="server" Text="Iniciar Sesión" CssClass="btn btn-primary btn-lg fw-bold rounded-pill shadow-sm w-100 btn-hover-scale" OnClick="btnLogin_Click" />
                </div>
                <div class="text-center mt-4">
                    <span class="text-muted small">¿No tenés cuenta?</span>
                    <a href="Registro.aspx" class="text-primary fw-bold text-decoration-none ms-1 small">Registrarme</a>
                </div>
            </div>
        </div>
    </div>
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            btnToggle.addEventListener("click", function () {
                if (txtPassword.type === "password") { txtPassword.type = "text"; eyeIcon.classList.replace("fa-eye", "fa-eye-slash"); }
                else { txtPassword.type = "password"; eyeIcon.classList.replace("fa-eye-slash", "fa-eye"); }
            });
        });
    </script>
</asp:Content>