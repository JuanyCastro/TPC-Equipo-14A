                ...
                <asp:Panel ID="pnlFormulario" runat="server" DefaultButton="btnRegistrar">
                    <div class="row gx-2 mb-3">
                        <div class="col-6">
                            ...
                            <asp:RequiredFieldValidator ID="rfvNombre" runat="server" ControlToValidate="txtNombre" ErrorMessage="Campo requerido." CssClass="text-danger small ms-2" Display="Dynamic" />
                        </div>
                        <div class="col-6">
                            ...
                            <asp:RequiredFieldValidator ID="rfvApellido" runat="server" ControlToValidate="txtApellido" ErrorMessage="Campo requerido." CssClass="text-danger small ms-2" Display="Dynamic" />
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <asp:RequiredFieldValidator ID="rfvEmail" runat="server" ControlToValidate="txtEmail" ErrorMessage="Campo requerido." CssClass="text-danger small ms-2" Display="Dynamic" />
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <asp:RequiredFieldValidator ID="rfvTelefono" runat="server" ControlToValidate="txtTelefono" ErrorMessage="Campo requerido." CssClass="text-danger small ms-2" Display="Dynamic" />
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <asp:RequiredFieldValidator ID="rfvPass" runat="server" ControlToValidate="txtPassword" ErrorMessage="La contraseña es obligatoria." CssClass="text-danger small ms-2" Display="Dynamic" />
                        <asp:RegularExpressionValidator ID="revPass" runat="server" ControlToValidate="txtPassword" ValidationExpression="^.{6,}$" ErrorMessage="Debe tener al menos 6 caracteres." CssClass="text-danger small ms-2" Display="Dynamic" />
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <asp:CompareValidator ID="cvPass" runat="server" ControlToValidate="txtConfirmPassword" ControlToCompare="txtPassword" ErrorMessage="Las contraseñas no coinciden." CssClass="text-danger small ms-2" Display="Dynamic" />
                    </div>
                    
                    <asp:Label ID="lblError" runat="server" CssClass="text-danger small fw-bold mb-3 d-block text-center"></asp:Label>

                    <div class="mt-3">
                        <asp:Button ID="btnRegistrar" runat="server" Text="Registrarme" CssClass="btn btn-primary btn-lg fw-bold rounded-pill shadow-sm w-100 btn-hover-scale" OnClick="btnRegistrar_Click" />
                    </div>
                </asp:Panel>
